...
const PrivacyPolicy: React.FC = () => {
  return (
    <div className="min-h-screen mt-16 p-8">
      ...
      <p className="mb-6 text-lg leading-relaxed">雷は、本ウェブサイト上で提供するサービス（以下、「本サービス」といいます。）における、アカウントの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます。）を定めます。</p>
      <h1 className="text-3xl font-bold mb-4">第1条（個人情報）</h1>
      <p className="mb-6 text-lg leading-relaxed">「個人情報」とは、個人情報保護法にいう「個人情報」を指すものとし、生存する個人に関する情報であって、当該情報に含まれる氏名、生年月日、住所、電話番号、連絡先その他の記述等により特定の個人を識別できる情報及び容貌、指紋、声紋にかかるデータ、及び健康保険証の保険者番号などの当該情報単体から特定の個人を識別できる情報（個人識別情報）を指します。</p>
      <h1 className="text-3xl font-bold mb-4">第2条（個人情報の収集方法）</h1>
      <p className="mb-6 text-lg leading-relaxed">雷は、アカウントが利用登録をする際に、メールアドレスなどの個人情報をお尋ねすることがあります。</p>
      ...
      <p className="mb-6 text-lg leading-relaxed">利用目的やプライバシーポリシーの変更を行った場合には、ウェブサイトで利用目的の変更をしたことを通知します。</p>
